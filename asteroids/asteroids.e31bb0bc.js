      ...
      function (require, module, exports) {
        ...
        function asteroidShape(x, y, radiuses) {
          ...
          for (var a = 0; a < TWO_PI; a += angle) {
            ...
            vertex(
              sx,
              sy,
              sx + radiuses[i] + xOffset,
              sy + radiuses[i] + yOffset
            );
            i++;
          }
        ...
        var Asteroid = /*#__PURE__*/ (function () {
          function Asteroid(location, velocity) {
            ...
            this.angle = 0;
            var speed = p5.Vector.sub(
              location,
              p5.Vector.add(location, velocity)
            ).mag(); // static asteroids
            ...
            this.health = Math.round(
              random(ASTEROID_MIN_HEALTH, ASTEROID_MAX_HEALTH)
            );
            this.size = map(
              this.health,
              ASTEROID_MIN_HEALTH,
            ...
            this.npoints = Math.round(
              random(ASTEROID_MIN_POINTS, ASTEROID_MAX_POINTS)
            );
          ...
          _createClass(Projectiles, [
            ...
            },
            {
              ...
              value: function hit(asteroid) {
                ...
                var nailedProjectiles = Array.from(this.projectiles).filter(
                  function (p) {
            ...
            },
            {
              ...
              value: function shoot() {
                ...
                if (keyIsDown(SPACE) && frameCount % 4 == 0) {
                  var rightCannon = createVector(
                    this.origin.x + 28,
                    this.origin.y - 10
                  );
                  rightCannon = rotatePoint(
                    rightCannon,
                    this.origin,
                    this.angle
                  );
                  var leftCannon = createVector(
                    this.origin.x - 28,
                    this.origin.y - 10
                  );
